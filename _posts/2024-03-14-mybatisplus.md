...
##### ![image-20210801175555953](/img/assets/2024-03-14-mybatis/image-20210801175555953.png) ②：选择当前模块需要使用的技术集（仅保留JDBC）

![image-20210801175658648](/img/assets/2024-03-14-mybatis/image-20210801175658648.png) 
...
![image-20210815150629727](/img/assets/2024-03-14-mybatis/image-20210815150629727.png)
...
![image-20210801180723261](/img/assets/2024-03-14-mybatis/image-20210801180723261.png)
...
![image-20210815153626017](/img/assets/2024-03-14-mybatis/image-20210815153626017.png)
...
![image-20210815153930073](/img/assets/2024-03-14-mybatis/image-20210815153930073.png)
...
![image-20210815154115368](/img/assets/2024-03-14-mybatis/image-20210815154115368.png)
...
![image-20210801181232962](/img/assets/2024-03-14-mybatis/image-20210801181232962.png)
...
![image-20210801182004226](/img/assets/2024-03-14-mybatis/image-20210801182004226.png)
...
![image-20210801182722773](/img/assets/2024-03-14-mybatis/image-20210801182722773.png)
...
![image-20210801182809131](/img/assets/2024-03-14-mybatis/image-20210801182809131.png)

#### 4.3 问题三：采用默认查询开放了更多的字段查看权限

- 在模型类属性上方，使用**@TableField**注解，通过**==select==**属性：设置该属性是否参与查询。此属性与select()映射配置不冲突。

![image-20210801220534494](/img/assets/2024-03-14-mybatis/image-20210801220534494.png) 

#### 4.4 问题四：表名与编码开发设计不同步

- 在<u>**模型类**</u>上方，使用**@TableName**注解，通过**==value==**属性，设置当前类对应的数据库表名称。

![image-20210801220807882](/img/assets/2024-03-14-mybatis/image-20210801220807882.png)
...
- 相关属性
    ...
    ![image-20210801192449901](/img/assets/2024-03-14-mybatis/image-20210801192449901.png) 
...
![image-20210801183128266](/img/assets/2024-03-14-mybatis/image-20210801183128266.png)

##### 表名前缀全局配置

![image-20210801183157694](/img/assets/2024-03-14-mybatis/image-20210801183157694.png)
...
![image-20210801183334584](/img/assets/2024-03-14-mybatis/image-20210801183334584.png) 
...
![image-20210801183459750](/img/assets/2024-03-14-mybatis/image-20210801183459750.png) 

#### 3.1 逻辑删除案例

##### ①：数据库表中添加逻辑删除标记字段

![image-20210801183545635](/img/assets/2024-03-14-mybatis/image-20210801183545635.png) 
...
![image-20210801223228871](/img/assets/2024-03-14-mybatis/image-20210801223228871.png) 
...
![image-20210801183851887](/img/assets/2024-03-14-mybatis/image-20210801183851887.png) 

#### 4.1 乐观锁案例

##### ①：数据库表中添加锁标记字段

![image-20210801183929041](/img/assets/2024-03-14-mybatis/image-20210801183929041.png) 
...
![image-20210801223855681](/img/assets/2024-03-14-mybatis/image-20210801223855681.png) 
...
![image-20210801224114650](/img/assets/2024-03-14-mybatis/image-20210801224114650.png)

- 实体对象类模板

![image-20210801184632944](/img/assets/2024-03-14-mybatis/image-20210801184632944.png)
